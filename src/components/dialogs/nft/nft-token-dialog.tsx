...
export function NFTTokenDialog({
    ...
    useEffect(() => {
        async function fetchData() {
            if (open && token) {
                ...
                console.log('Family currency Address:', address);
                if (address) {
                    try {
                        ...
                        if (tokenPrice) {
                            ...
                            console.log('Last sale:', tokenPrice);
                            console.log('Last sale in family currency:', calculatedSale);
                        } else {
                            console.log('Token price is not available');
                            setLastSale(null);
                        }
                    } catch (error) {
    ...
    const handleBuyNow = useCallback(() => {
        console.log('Buy now clicked for token:', token?.token.tokenId);
