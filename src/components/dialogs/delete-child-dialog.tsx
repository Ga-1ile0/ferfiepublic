...
export function DeleteChildDialog({
  ...
  const handleDelete = async () => {
    ...
    setIsDeleting(false);
    // onConfirm is expected to handle closing the dialog and showing toasts
    // If onConfirm doesn't close, you might add onOpenChange(false) here.
    // However, letting the parent handle close after API call is better.
  };
