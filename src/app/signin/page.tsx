            ...
            try {
                ...
                if (result.status === 200 && result.data) {
                    ...
                    if (result.message === 'This code has already been used') {
                        setAuthError('This sign-in code has already been used. Please request a new one from your parent.');
                    } else {
...
setShowQrScanner(false);
            ...
            try {
                ...
                if (validationResult.status === 200 && validationResult.data) {
                    ...
                    setAuthError('This QR code has already been used. Please request a new one from your parent.');
                } else {
        ...
        if (inputElement) {
            const handler = (event: Event) => {
                ...
                if (cursorPosition === 5 && inputValue.length < formattedValue.length) {
                    ...
                    const newCursorPosition = cursorPosition > 4 && inputValue.length < formattedValue.length
                        ? cursorPosition + 1
        ...
        <div className="container flex items-center justify-center min-h-screen min-w-screen px-4 py-8">
            ...
            <Card className="w-full max-w-md">
                <CardHeader className="text-center">
                    <CardTitle className="text-2xl flex justify-center">Welcome! {isConnected ? <LogOut onClick={logout} className="text-red-800 hover:cursor-pointer" /> : null}</CardTitle>
                        ...
                        <TabsContent value="parent">
                            ...
                            {showQrScanner ? (
                                ...
                                <div className="space-y-4">
                                    ...
                                    <WalletModal isOpen={isWalletModalOpen} onClose={() => setIsWalletModalOpen(false)} className='bg-black/80 rounded-xl' />
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Input
                                            ...
                                            onPaste={(e) => {
                                                ...
                                                if (uiUserType === 'kid' && formattedValue.replace(/\s/g, '').length === 8) {
